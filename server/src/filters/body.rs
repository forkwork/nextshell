...
/// let upload = nextshell::body::content_length_limit(4096)
///     .and(nextshell::body::aggregate());
/// ```
...
///
/// ```
/// use nextshell::{Buf, Filter};
///
/// let route = nextshell::body::content_length_limit(1024 * 32)
