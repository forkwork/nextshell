...
Welcome to the examples! These show off `nextshell`'s functionality and explain how to use it.
...
Congratulations, you have just run your first nextshell service!
...
Hooray! `nextshell` also includes built-in support for WebSockets
